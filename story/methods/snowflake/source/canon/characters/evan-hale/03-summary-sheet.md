...
A workaholic controls engineer who responds to helplessness by solving problems, even when the work itself becomes the thing destroying what he hopes to save.

## Motivation

To protect Ruth from decline and prove that his care can accomplish something concrete.
...
Every success pulls him away from Ruth, validates his worst coping mechanism, and removes versions of himself capable of stopping. He becomes increasingly correct by erasing worlds in which he is wrong.

## Relationship with Ruth

Ruth is his mother, assistant, intellectual companion, dependent, and moral witness. The garage project begins as a way to remain close. Evan's tragedy is that he eventually chooses the machine while telling himself he is choosing Ruth.
...
does not make a clean decision to exclude her. He lets the project move ahead
until the activity they shared has become his private urgency.
...
When Lena suspects the distributed containment system is a carrier, she refuses
the live proof whose result would determine the participating labs' containment
...
institution has legal or physical control over his private garage, so he
remains technically able to restart it, but he does not request an exception
and his garage is excluded from the selected-site restart.

He treats the death as an engineering and containment failure. The survivor's
selective autobiographical loss is real and deeply troubling, but the physical
trauma keeps its cause medically ambiguous. Evan's compliance with the hold is
sincere. Once selected sites can restart under stronger controls, he believes
continued measurement is the responsible way to find the failure and prevent
another death.

Evan joins the restart as a technical adviser with full access to shared data,
controller logs, and containment records. He helps design safeguards and
interpret results, but he cannot approve or operate a consequential run alone.
When Lena refuses the proof-to-stop test, he formulates and sponsors it through
the consortium's shared approval process. Participating sites authorize and
execute it under local control. Evan follows the formal procedure, and that
procedure becomes part of the carrier.

Evan discloses the carrier hypothesis, the risk that the test's own response
may complete it, and Lena's stated reason for refusing. Reviewers, site leads,
and operators approve with that information. He believes their informed
consent and shared authority make the test legitimate. He does not yet
...
from active work surprises him. He recognizes that she has drawn a moral
boundary but initially experiences it as leaving when the work matters most.
...
His first objective clarity result solves a zero-speed motor-estimator failure
at work. In the unobservable band where back electromotive force vanishes into
noise, he stops forcing one electrical-angle estimate and carries both valid
hypotheses until measurement can distinguish them again. The insight uses
...
later live consequential-bit result convinces him that the apparatus has
exposed new physics, and he calls Lena to examine that physical claim.
Lena is the first to align his changed operator behavior with the anomalous
sensor window. When she asks what happened, he describes the flow state. A
blinded recurrence makes `operator effect` their working description, though
it establishes neither enhancement nor mechanism.

Ruth's first lucidity occurs incidentally while she is carrying out a real
task in a live run. Afterward she requests reduced repeat exposures. Evan and
the team initially agree. His failure is not that he fabricates her consent,
but that a benefit she genuinely wants becomes another program of work he
cannot leave alone.
...
During shared contact, Evan visually recovers structured residue that Tess
independently recovers spatio-acoustically or relationally. It contains details
he never knew and loses degrees of freedom under further projection. He and
Tess infer what the entities never explain: histories are disappearing from
...
more of the immediate relational perturbation directly. This escalation comes
from lost causal insulation, not the entity approaching or Evan learning a new
perceptual skill. His later simultaneous experiences with Tess establish
shared contact without giving them identical perceptions or merging their
points of view.
...
himself. His first reconstruction is therefore an object under observation,
not the reciprocal relation Tess perceives spatio-acoustically.

During terminal geometric failure, Evan keeps this object-centered orientation.
He sees stable bounded things, surfaces, and physical traces arranged along
routes that cannot compose into one global map. Tess's acoustic atlas describes
the same damaged substrate from within its relations. Objects and signals cross
between them, but neither account can become the master geometry or replace the
other.

He initially recovers one recurring presence as an impossible demonstration.
Each failed attempt to understand it becomes part of the next showing. Its
content does not survive recovery, but the conviction that something showed
him how to continue does. He calls that residue the Guide. Its stable movement
is the converted interruption: every obstacle, contradiction, refusal,
alternative, or stop becomes the next condition of continued operation. He
later recognizes the Guide as ruined. Everything that made its transformations
unique has been flattened until it feels like a sovereign without a subject.
This is an Evan-shaped expression of the projector operation. As the operation
exhausts its own counterfactual support, the presence loses degrees of movement
until one simple unfold can only recreate and repeat itself. `Ruined
Sovereign` is primarily an internal planning label, and whether Evan uses the
full name remains late-bound.

During shared Sovereign contact, Tess recovers the same converted interruption
as a reply made on her behalf. Evan's sense of guidance and Tess's sense of
preemption establish common contact without making their experiences parallel.
Her ability to reject the reply as not hers marks the independence the
operation has not absorbed.
...
3. A prior miscarriage exposed his habit of converting pain into work. His wife
   cried in the bathroom. Evan yelled from pain rather than anger, a distinction
   that did not make the experience less damaging. They retrieved the
   miscarriage from the toilet and buried it in a planter. Flowers grew, but
   both of them neglected the planter while Evan buried himself in work. His
   workaholism and emotional absence contributed to the marriage's collapse,
   although the marriage is not a lost ideal family he must recover. The book
   is not a search for a daughter he never knew, and Ruth's alternate memory of
...
- **Starting state:** Loving, competent, sad, and already overworking; the garage gives him and Ruth a shared language.
- **First reversal:** The anomaly produces real clarity and an objectively
  successful zero-speed motor-control insight, which he mistakes for his own
  epiphany. Evan stops waiting when Ruth wanders away and lets the formerly
  shared project advance without her.
- **Escalation:** He lets fresh random bits control live physical actions and
  finds that they become biased only when their choices have real
  consequences. Reversing the mapping preserves the favored action.
- **Moral injury:** Ruth becomes lucid but remembers a surviving granddaughter
  absent from his history. Evan treats the discrepancy as an overshoot and
  starts optimizing for autobiographical concordance with his own record
  family.
- **Addiction:** Continued runs become euphoric and ontologically self-selecting.
- **Formalization:** Lena's independent replicas turn the discovery into a
  multi-site study. A local accident kills one researcher and leaves another
  unable to remember the dead collaborator or their shared years. Evan accepts
  the evidence hold and voluntarily powers down the garage while retaining the
  original ring. He treats the death as an engineering failure and the memory
  loss as medically confounded, then supports a bounded restart as the
  responsible way to prevent another death. He joins as a technical adviser
...
- Moves two fingers in a small clockwise circle while tracing control flow.
- Explains science at length as a form of intimacy.
