...
- How Tess's rarity is discovered without turning her into a numerical magic key.
- How branch capacity is conserved or reallocated at genesis.
- Which stable invariants might seed the child universe's laws.

### Explicitly deferred until the final chapter or two are outlined

- Whether mutual veto is the final terminal structure or only an emotional model.
...
- The miscarriage planter and dead flowers.
- The garage couch.
- Ruth's garden.
